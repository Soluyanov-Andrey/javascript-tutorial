...
/**
 * Можно передать переменную в ${}
 */

let a = 15 ;
console.log(`Привет мир!! ${a}`);
/**
 * В javascript знак ";" можно ставить а можно нет в конце строки. Но если в строке
 * несколько, обращений например два console.log то знак точки с запятой обязателен.
 *
 */
console.log("Привет мир 1"); console.log("Привет мир 2");
