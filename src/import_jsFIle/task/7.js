 ...
 * Реализовали функцию перебирающию с помощью for так как в предыдущем
 * варианте, получалось что функция найдя нужный узел продолжала перебирать дальше
 * а теперь return и вышла.
